...
class LawyerPhone extends StatefulWidget {
  final List phoneList;

  LawyerPhone(this.phoneList);

  @override
  _LawyerPhoneState createState() => _LawyerPhoneState();
}

class _LawyerPhoneState extends State<LawyerPhone> {
  @override
                          ...
                          child: Column(
                            children: <Widget>[
                              PhoneListPage(
                                ...
                                isLast: index == widget.phoneList.length - 1
                                    ? true
                                    : false,
                                onAdd: () {
                                  Photo addList = Photo(
...
class _PhoneListPageState extends State<PhoneListPage> {
  ...
  void lawyerContacts(value) {
    if (value == '') return;
    lawyerInFoViewModel
        .lawyerContacts(context, title: name, value: value, type: 1)
        .then((rep) {
    ...
    if (widget.id == null) {
      ...
      lawyerInFoViewModel
          .lawyerContactsChange(context,
              id: widget.id, title: name, value: value, type: 1)
          .then((rep) {
              ...
              Expanded(
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    onSubmitted: (value) {
                      print('值为:' + value);
                      if (isMobilePhoneNumber(value) == false) {
