...
class HudView {
  ...
  static OverlayEntry overlayEntry = new OverlayEntry(builder: (context) {
  ...
  ///定时关闭
  static void timerTread([int s = 5]) {
  ...
  static void show(BuildContext context, {msg = '加载中...', int second = 5}) {
    if (context == null) {
      return;
    }
