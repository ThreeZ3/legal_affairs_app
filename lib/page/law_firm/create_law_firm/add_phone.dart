...
class PhoneListWidget extends StatefulWidget {
  ...
  @override
  _PhoneListWidgetState createState() => _PhoneListWidgetState();
}

class _PhoneListWidgetState extends State<PhoneListWidget> {
                  ...
                  child: TextField(
                    ...
                    onSubmitted: (value) {
                      if (isMobilePhoneNumber(value) == false) {
                        showToast(context, '请填写正确的手机号码格式');
                      } else {
                        changeValue();
                      }
                    },
